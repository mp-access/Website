<section class="page-section" data-id="team">
  <div class="container">
    <div class="row">
      <div class="col-sm-8">
        <h2 class="pb-3">Team</h2>
        <h4>ACCESS was developed in the context of a master project at the University of Zurich by four&nbsp;master students under the direction of the Departement of Informatics.</h4>
      </div>
    </div>
    <br>
    <div class="row justify-content-center pt-3">
      <div class="col-sm-6 col-md-4 mb-5 scroll-reveal slide-down" data-reveal-id="reveal-team">
        <div class="profile panel">
          ...
          <h4>Alexander Hofmann</h4>
          <hr class="short">
          <h5 class="mb-3">Master Student @ UZH</h5>
          <div class="icon-box">
            <a href="https://github.com/a-a-hofmann" target="_blank">
      ...
      <div class="col-sm-6 col-md-4 mb-5 scroll-reveal slide-down" data-reveal-id="reveal-team">
        <div class="profile panel">
          ...
          <h4>Luka Lapanashvili</h4>
          <hr class="short">
          <h5 class="mb-3">Master Student @ UZH</h5>
          <div class="icon-box">
            <a href="https://overcastfilms.ch" target="_blank">
              <i data-feather="link"></i>
            </a>
            <a href="https://twitter.com/HaeriStudios" target="_blank">
              <i data-feather="twitter"></i>
            </a>
            <a href="https://github.com/Haeri" target="_blank">
              <i data-feather="github"></i>
            </a>
          </div>
        </div>
      ...
      <div class="col-sm-6 col-md-4 mb-5 scroll-reveal slide-down" data-reveal-id="reveal-team">
        <div class="profile panel">
          ...
          <h5 class="mb-3">Master Student @ UZH</h5>
          <div class="icon-box">
            <a href="https://github.com/mech-studi" target="_blank">
              <i data-feather="github"></i>
            </a>
          </div>
        </div>
      ...
      <div class="col-sm-6 col-md-4 mb-5 scroll-reveal slide-down" data-reveal-id="reveal-team">
        <div class="profile panel">
          ...
          <h4>Philip Hofmann</h4>
          <hr class="short">
          <h5 class="mb-3">Master Student PoC @ UZH</h5>
          <div class="icon-box">
            <a href="https://phhofm.github.io/" target="_blank">
              <i data-feather="link"></i>
            </a>
            <a href="https://www.facebook.com/phhofm" target="_blank">
              <i data-feather="facebook"></i>
            </a>
            <a href="https://github.com/phhofm" target="_blank">
              <i data-feather="github"></i>
            </a>
          </div>
        </div>
